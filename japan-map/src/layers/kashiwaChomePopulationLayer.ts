...
//     const isPercent = propName === "高齢化率" || propName === "aging_rate_2040";
//     if (isPercent) {
//         // 1 decimal + % ; empty when null
//         return [
//             "case",
...
//             [
//                 "concat",
//                 ["to-string", ["/", ["round", ["*", ["to-number", ["get", propName]], 10]], 10]],
//                 "%"
//             ]
//         ];
//     }
//     // numbers (総数 / 人口密度) ; empty when null
//     return [
//         "case",
//         ["==", ["coalesce", ["get", propName], null], null],
//         "",
...
// // --- keep runtime state for label behavior ---
