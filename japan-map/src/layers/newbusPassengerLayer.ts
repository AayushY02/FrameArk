...
export const toggleNewBusPassengerLayer = (
    ...
    const geojsonUrl = '/data/new_kashiwakuru_stops.geojson'; // 🧠 Ensure this path is served in your Vite public folder
...
export const toggleNewKashiwakuruRideLayer = (
    ...
    const geojsonUrl = '/data/new_kashiwakuru_stops.geojson';
