...
//     const addShopsLayer = async (map: mapboxgl.Map, selectedCategories: string[]) => {
...
//         const sourceId = 'kashiwa-shops';
//         // Vercel path (your file is written to public/tiles by your script)
//         const pmtilesUrl = `${location.origin}/tiles/kashiwa_shops.pmtiles`;
//         // Tippecanoe -l layer name produced by your script for this file
//         const SOURCE_LAYER = 'kashiwa_shops';

//         // Read header for min/max zoom (and optional bounds / center)
//         const h = await PmTilesSource.getHeader(pmtilesUrl);

//         // Add the PMTiles source if not present
//         if (!map.getSource(sourceId)) {
//             map.addSource(sourceId, {
//                 // IMPORTANT: use the custom PMTiles source type
